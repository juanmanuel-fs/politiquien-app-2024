...
function SideRightModal({title, children, open, setOpen}: SideRightModalProps) {
  ...
  return (
    <div className="fixed z-50 left-0 right-0 top-0 bottom-0 w-screen h-screen bg-black-50">
      <div className="fixed right-0 top-0 bottom-0 w-screen md:w-[480px] p-6 bg-white-100 flex flex-col overflow-auto">
