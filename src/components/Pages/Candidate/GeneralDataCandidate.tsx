    ...
    >
      <>
        <div className='flex flex-col gap-6'>
          <div>
            <h6 className='text-black-75 capitalize font-medium mb-2'>Personales:</h6>
          ...
          <div>
            <h6 className='text-black-75 capitalize font-medium mb-2'>Lugar de nacimiento:</h6>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-2'>
          ...
          <div>
            <h6 className='text-black-75 capitalize font-medium mb-2'>Lugar de domicilio:</h6>
            <div className='grid grid-cols-1 md:grid-cols-2 gap-2'>
