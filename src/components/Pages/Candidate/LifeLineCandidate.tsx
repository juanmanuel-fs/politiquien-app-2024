            ...
            <div className='flex flex-col gap-6 relative'>
              <span className='absolute h-full -mt-4 w-1 left-1/2 rounded-t-full  bg-black-22 '></span>
              {
                line.map((ln: any, index) => {
                    ...
                    result = (
                      <div className='relative'>
                        <div className='flex flex-col'>
                          ...
                          <p className='mt-2 text-callout'>{!! parseInt(ln.endAnio) ? 'Fue' : 'Es'} partidario de la organización <span className='text-footnote font-semibold'>{ln.nameOrganization}</span ></p>
                          {
                            !!ln.comment &&
                    ...
                    result = (
                      <div className='relative'>
                        <div className='flex flex-col'>
                          ...
                          <p className='mt-2 text-callout'>{!! parseInt(ln.endAnio) ? 'Fue' : 'Es'} electo de la organización <span className='text-footnote font-semibold'>{ln.nameOrganization}</span ></p>
                          {
                            !!ln.comment &&
                            <div className='mt-1 flex flex-col gap-0'>
                              <small className='text-black-50'>Comentó:</small>
                    ...
                    result = (
                      <div className='relative'>
                        <div className='flex flex-col'>
                          ...
                          <p className='mt-2 text-callout'>Renunció a la organización <span className='text-footnote font-semibold'>{ln.nameOrganization}</span ></p>
                          {
                            !!ln.comment &&
                            <div className='mt-1 flex flex-col gap-0'>
                              <small className='text-black-50'>Comentó:</small>
                  ...
                  return (
                    <div className={`p-4 ring-1 ring-black-22 rounded-xl bg-white-100 z-10 ${index % 2 ? 'text-right mr-[15%] md:mr-[30%]' : 'text-left ml-[15%] md:ml-[30%]'}`} key={index}>
                      {result}
                    </div>
                  )
