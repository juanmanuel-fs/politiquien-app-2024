    ...
    <>
      ...
      > 
        <div className='grid grid-cols-1 md:grid-cols-2 gap-2'>
          <ModalButtonCandidate title='FALTAS FISCALES' count={20} countColor='bg-orange-500' onCLick={() => {setFaultsModal('fiscals'); setOpenFaultModal(true)}}/>
      ...
      </AccordionCandidate>
      {
        ...
        <GeneralModal setOpen={setOpenFaultModal} title='FALTAS FISCALES' open={openFaultModal} primary='Falta' secondary='Estado'>
          <div className='flex flex-col'>
            <AccordionDeclarationCandidate description='BACHILLER EN ADMINISTRACION' value='ARCHIVADO'>
            ...
            <AccordionDeclarationCandidate description='BACHILLER EN ADMINISTRACION' value='CULPABLE'>
              <div className='grid grid-cols-12 gap-2'>
