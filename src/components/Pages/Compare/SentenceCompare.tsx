    ...
    <div className='flex flex-col gap-2 md:gap-4'>
      ...
      <div className='flex flex-col gap-2 md:gap-4'>
        <div className='flex flex-col gap-1'>
          <p className='text-footnote md:text-subhead text-black-50 mr-2'>Penal:</p>
        ...
        <hr/>
        <div className='flex flex-col gap-1'>
          <p className='text-footnote md:text-subhead text-black-50 mr-2'>obligatoria:</p>
          <div className='grid grid-cols-2 gap-4 md:gap-8 text-black-100'>
            <div className='flex flex-col gap-2'>
              <div className='flex flex-col md:flex-row md:justify-between md:gap-4'>
