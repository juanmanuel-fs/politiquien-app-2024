      ...
      <div className=''>
        <div className='flex flex-col mb-6 gap-4'>
          <div className='flex flex-row justify-between items-center gap-2'>
            <h2 className='text-title3'>PROCESOS ELECTORALES</h2>
          ...
          <div className='flex flex-row gap-2 w-full md:gap-4 '>
            <div className='w-full'>
              <InputText 
                ...
                placeholder='Buscar Proceso Electoral' 
                type='black'
              />
            </div>
            <div className='flex-none hidden md:block'>
              <SimpleSelect name='state' options={state} value={filterSearchNews.state} change={handleSelect} placeholder='Seleccione proceso electoral'/>
            </div>
        ...
        <div className='flex flex-row gap-2'>
          ...
          <div className='flex flex-col justify-center'>
            ...
            <span className='block text-headline font-normal'>142 Procesos</span>
          </div>
        </div>
      </div>
